...
const st = StyleSheet.create({
  ...
  tabLabel: { fontSize: 10, color: Colors.textMuted, fontWeight: '600', letterSpacing: 0.1 },
  ...
  glowRing: {
    ...
    backgroundColor: Colors.aiAccent, opacity: 0.35,
  },
  centerBtn: {
    width: 58, height: 58, borderRadius: 29,
    backgroundColor: Colors.aiAccentDark,
  ...
  centerLabel: { color: Colors.aiAccent, fontSize: 10, fontWeight: '800' },
});
